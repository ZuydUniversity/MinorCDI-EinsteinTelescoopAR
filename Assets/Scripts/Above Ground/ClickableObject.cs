...
public class ClickableObject : MonoBehaviour
{
    ...
    /// <summary>
    /// Id to recognise which lever it is so which function should run if the lever is toggled
    /// </summary>
    public int Id;
    /// <summary>
    /// Root of starspawner used to toggle showwaves
    /// </summary>
    public GameObject StarSpawnerRoot;
    /// <summary>
    ...
    public void ToggleLever()
    {
        ...
        if (isOn)
        {
            ...
            //Id == 0 for Showwaves lever
            if (Id == 0) { StarSpawnerRoot.GetComponent<StarSpawner>().StartAnimation(); }
        }
        else
        {
            ...
            //Id == 0 for Showwaves lever
            if (Id == 0) { StarSpawnerRoot.GetComponent<StarSpawner>().StopAnimation(); }
        }
